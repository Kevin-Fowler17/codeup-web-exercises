...
function startsAndEndsWithVowel(str) {
    ...
    if (first.match(/[aeiou]/i) && last.match(/[aeiou]/i)) {
        return true;
    } else {
        return false;
    }
...
// Exercise 59
// Write a function definition named firstToLast that takes in sequence and returns the sequence with the
// first value moved to the end of the sequence.
...
function median(sequence) {
    ...
    var half = Math.floor(sequence.length / 2);

    if (sequence.length % 2)
        return sequence[half];
    return (sequence[half - 1] + sequence[half]) / 2.0;
...
function onlyOddNumbers(numbers) {
    let oddElements = numbers.filter(element => element % 2 !== 0);
    return oddElements;
}
...
function onlyEvenNumbers(numbers) {
    let evenElements = numbers.filter(element => element % 2 === 0);
    return evenElements;
}
...
function onlyPositiveNumbers(numbers) {
    let positiveElements = numbers.filter(element => element > 0);
...
function onlyNegativeNumbers(numbers) {
    let negativeElements = numbers.filter(element => element < 0);
...
function hasEvens(numbers) {
    ...
    let hasEvensCount = numbers.some(element => element % 2 === 0);

    return hasEvensCount;
}
...
function countEvens(numbers) {
    ...
    let evensTotal = numbers.filter(element => element % 2 === 0);

    return evensTotal.length;
}
...
function hasOdds(numbers) {
    ...
    let hasOddsCount = numbers.some(element => element % 2 !== 0);
...
function countOdds(numbers) {
    ...
    let oddsTotal = numbers.filter(element => element % 2 !== 0);

    return oddsTotal.length;
}
...
function countNegatives(numbers) {
    ...
    let negativesTotal = numbers.filter(element => element < 0);

    return negativesTotal.length;
}
...
function countPositives(numbers) {
    ...
    let positivesTotal = numbers.filter(array => array > 0);

    return positivesTotal.length;
}
...
function onlyPositiveEvens(numbers) {
    ...
    let positiveEvens = numbers.filter(element => (element > 0 && element % 2 === 0));
...
function onlyPositiveOdds(numbers) {
    ...
    let positiveOdds = numbers.filter(element => (element > 0 && element % 2 !== 0));
...
function onlyNegativeEvens(numbers) {
    ...
    let negativeEvens = numbers.filter(element => (element < 0 && element % 2 === 0));
...
function onlyNegativeOdds(numbers) {
    ...
    let negativeOdds = numbers.filter(element => (element < 0 && element % 2 !== 0));
...
function totalOfBookPrices(objects) {

    return objects.reduce((accumulator, object) => {return accumulator + object.price;}, 0);
...
function highestPriceBook(objects) {
    ...
    let object = objects.sort((a, b) => b.price - a.price);
...
function lowestPriceBook(objects) {

    let object = objects.sort((a, b) => a.price - b.price);
...
function numberOfItemTypes(objects) {

    return objects.items.length;
}
...
function totalNumberOfItems(objects) {

    return objects.items.reduce((accumulator, object) => {return accumulator + object.quantity;}, 0);
...
function getAverageItemPrice(objects) {

    let sum = objects.items.reduce((accumulator, object) => {return accumulator + object.price;}, 0);
    return sum / objects.items.length;
...
function getAverageSpentPerItem(objects) {

    let sum = objects.items.reduce((accumulator, object) => {return accumulator + object.price;}, 0);
    let totalItems = objects.items.reduce((accumulator, object) => {return accumulator + object.quantity;}, 0);
}
